...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getWildControllerService()
    {
        ...
        $instance->setContainer(($this->privates['.service_locator.vdmMuyE'] ?? $this->get_ServiceLocator_VdmMuyEService())->withContext('App\\Controller\\WildController', $this));
